...
//    
//    float fff = _foregroundScrollView.frame.size.height - _foregroundScrollView.contentInset.top - _viewDistanceFromBottom;
//    NSLog(@"%f",fff);
//    
...
//    [_foregroundScrollView setContentSize:CGSizeMake(self.frame.size.width, _foregroundView.frame.origin.y + _foregroundView.frame.size.height)];
//}
//-(void)foregroundScrollViewStop{
////    _foregroundScrollView.decelerationRate = 0.0;
////    _backgroundScrollView.decelerationRate = 0.0;
//}
//- (void)scrollViewWillBeginDecelerating:(UIScrollView *)scrollView
//{
//    NSLog(@"位置%f",_foregroundScrollView.contentOffset.y);
////    if (_foregroundScrollView.contentOffset.y >= 100) {
//////        [_foregroundScrollView setContentOffset:CGPointMake(_foregroundScrollView.contentOffset.x, 100)];
...
//    [self sendObject:[NSString stringWithFormat:@"%f",ratio]];
//    
//    NSLog(@"位置:::%f",_foregroundScrollView.contentOffset.y);
//
//    
