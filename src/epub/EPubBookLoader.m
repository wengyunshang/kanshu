...
- (void)unzipAndSaveFile{
    ...
    if([za UnzipOpenFile:self.filePath]){
        ...
        NSString *strPath=[NSString stringWithFormat:@"%@/%@/",cacheDirectory,self.savePath];
        
        NSString *md5 = [EncryptHelper fileMd5:self.filePath];
        
        NSLog(@"%@",[ResourceHelper getUserDefaults:[self.filePath lastPathComponent]]);
...
- (NSString*) parseManifestFile{
    ...
    // @"/var/mobile/Containers/Data/Application/413354BE-0EFB-4EB4-9763-D810EE387B5D/Library/Caches/var/mobile/Containers/Data/Application/413354BE-0EFB-4EB4-9763-D810EE387B5D/Documents/诗经.epub/META-INF/container.xml";
    //@"/var/mobile/Containers/Data/Application/B8BB5F8F-B5A5-4A16-8261-52D75884F25E/Library/Caches//var/mobile/Containers/Data/Application/B8BB5F8F-B5A5-4A16-8261-52D75884F25E/Documents/1411307579.file/META-INF/container.xml
    //@"/var/mobile/Containers/Data/Application/B8BB5F8F-B5A5-4A16-8261-52D75884F25E/Library/Caches//var/mobile/Containers/Data/Application/B8BB5F8F-B5A5-4A16-8261-52D75884F25E/Documents/1411307580.file/META-INF/container.xml"	0x18d25100
	NSFileManager *fileManager = [[NSFileManager alloc] init];
...
- (void) parseOPF:(NSString*)opfPath{
    ...
    for (DDXMLElement* element in itemRefsArray) {
        if(![[[[element attributeForName:@"linear"] stringValue] lowercaseString] isEqualToString:@"no"]){
            ...
            if (![title isEqualToString:@"page.xhtml"] && ![title isEqualToString:@"catalog.xhtml"]) {
