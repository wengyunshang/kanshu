...
- (void)layoutSubviews {
    ...
    CGSize labelSize =[self.textLabel.text stringTextWidthFont:[UIFont systemFontOfSize:14.0f] maxWidth:226.0f];
    //[self.textLabel.text sizeWithFont:[UIFont systemFontOfSize:14.0f]
