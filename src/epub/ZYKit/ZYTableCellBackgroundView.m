...
- (id)initWithFrame:(CGRect) frame pos:(int)position{
    ...
    self.pos = position;
    self.bgColor = [[[UIColor alloc] initWithRed:232/255.f green:232/255.f blue:232/255.f alpha:1] autorelease];
    self.borderColor = [[[UIColor alloc] initWithRed:171/255.f green:171/255.f blue:171/255.f alpha:1] autorelease];
