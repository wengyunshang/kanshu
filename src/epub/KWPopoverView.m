...
- (void)tapped:(UITapGestureRecognizer *)tap
{
    ...
    NSLog(@"%f----%f----%f---%f",CGRectGetMinX(self.contentView.frame),CGRectGetMaxX(self.contentView.frame),CGRectGetMinY(self.contentView.frame),CGRectGetMaxX(self.contentView.frame));
    if ( point.x>CGRectGetMinX(self.contentView.frame)
        && point.x<CGRectGetMaxX(self.contentView.frame)
        && point.y>CGRectGetMinY(self.contentView.frame)
        && point.y<CGRectGetMaxY(self.contentView.frame)) {
