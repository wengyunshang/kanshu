...
- (void) removeCellAtIndex:(NSUInteger)rowIndex animated:(BOOL)animated {
	...
	if(animated) {
		...
		[self.tableView deleteRowsAtIndexPaths:[NSArray arrayWithObject:[NSIndexPath indexPathForRow:rowIndex inSection:sectionum]] withRowAnimation:UITableViewRowAnimationAutomatic];
