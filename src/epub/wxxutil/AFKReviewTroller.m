...
+ (void) load {
    ...
    int numberOfExecutions = (int)[standardDefaults integerForKey:kAFKReviewTrollerRunCountDefault] + 1;
...
+ (int) numberOfExecutions {
    return (int)[[NSUserDefaults standardUserDefaults] integerForKey:kAFKReviewTrollerRunCountDefault];
}
